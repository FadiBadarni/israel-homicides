...
const T: Record<Lang, Record<TranslationKey, string>> = {
  ar: {
    ...
    "contact.lede":
      "السجلّ ليس مكتملاً. هناك ضحايا لم تُوثَّق بعد، وتفاصيلُ تنتظر التوثيق. ساعدنا في إكماله.",
  ...
  he: {
    ...
    "contact.lede":
      "הרישום אינו שלם. ישנם קרבנות שעדיין לא תועדו, ופרטים הממתינים לתיעוד. עזרו לנו להשלים אותו.",
    "contact.cta": "צרו קשר",
