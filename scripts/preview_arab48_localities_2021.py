"""Fast 2021 candidate-list preview from arab48/محليات. See 2024 doc."""
...
DATE_TO = "2021-12-31"
# Pages 280-400 cover 2021 (verified earlier). Walk to 450 for headroom.
MAX_PAGES = 600
...
async def main() -> None:
    ...
    out_csv = Path("output/arab48_localities_2021_candidates.csv")
